...
SNSPush.prototype._endpointCreated = Meteor.bindEnvironment(function(endpointArn,deviceId,userId){
...
SNSPush.prototype._endpointRemoved = Meteor.bindEnvironment(function(endpointArn,deviceId,userId){
	SnsPushTokens.remove({token:endpointArn});
});
